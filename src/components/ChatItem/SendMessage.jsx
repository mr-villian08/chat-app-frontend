      ...
      <form onSubmit={sendMessageHandler}>
        <div className="flex justify-between">
          <input
            ...
            value={message}
            className="pl-4 p-2 2xl:w-[1220px] xl:w-[730px] bg-gray-800 rounded-lg outline-none"
          ...
          <div className="flex relative items-center text-center gap-6">
            ...
            >
              <img src={attachmentIcon} alt="Attachment" className="h-6 w-6" />
            ...
            <button className="flex items-center bg-green-700 gap-1 px-3 py-1.5 cursor-pointer font-semibold tracking-widest rounded-md hover:bg-green-600 duration-300 hover:gap-2 hover:translate-x-3">
